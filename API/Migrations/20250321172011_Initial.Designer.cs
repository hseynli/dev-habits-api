...
namespace API.Migrations
{
    ...
    [Migration("20250321172011_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.HabitTag", b =>
                {
            ...
            modelBuilder.Entity("API.Entities.Habit", b =>
                {
                    b.OwnsOne("API.Entities.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("API.Entities.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("API.Entities.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("API.Entities.HabitTag", b =>
                {
                    b.HasOne("API.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
